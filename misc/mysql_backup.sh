...
mysql tiki_gaming -e 'delete from sessions where expiry < UNIX_TIMESTAMP();'

mysql tiki_gaming -e 'truncate tiki_stats;'

mysql tiki_gaming -e 'delete from tiki_actionlog where lastmodif < UNIX_TIMESTAMP(CURRENT_DATE() - INTERVAL 6 MONTH);'
